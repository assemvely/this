					...
					<div class="col-md-12">
							...
							<div class="card-info"
								...
								<div class="userinfo">
									...
									<div class="userinfo"
										...
										<%-- <span class="card-title"><h4 style="margin-top:35px;">${user.id}</h4></span> --%>
						...
						<%-- <form action="/user/mypage">
							...
							<label class="radio-inline">
								<input type="radio" name="inlineRadioOptions" checked="checked" value="OUTER">OUTER </label>
								<label class="radio-inline">
								<input type="radio" name="inlineRadioOptions" value="TOP">TOP </label>
								<label class="radio-inline">
								<input type="radio" name="inlineRadioOptions" value="BOTTOM">BOTTOM</label>
								<label class="radio-inline">
								<input type="radio" name="inlineRadioOptions" value="DRESS">SKIRT</label>
								<label class="radio-inline">
								<input type="radio" name="inlineRadioOptions" value="ACC">ACC </label>
						...
						<form action="/user/mypage">
							<div class="checks">
								<fieldset data-role="controlgroup" data-type="horizontal">
									<!-- <label class="radio-inline"> -->
									<label id="sort">SORT > </label> <input type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=OUTER> OUTER <INPUT type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=TOP> TOP <INPUT type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=BOTTOM> BOTTOM <INPUT
										type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=SKIRT> SKIRT <INPUT type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=DRESS> DRESS <INPUT type=radio
										style="font-size: 20px; border: 1px solid #d9534f; width: 10px; height: 10px;"
										name=categorycode value=ACC> ACC <input type=hidden
										name=id value="${user.id}">
									<!-- </label> -->
									<input
										style="margin-left: 10px; align-items: flex-start; text-align: center; cursor: default; color: #ffffff; background-color: #d9534f; border-radius: 6px; box-sizing: border-box; padding: 10px 10px; border-width: 0px; border-style: solid; border-color: #d9534f; border-image: initial;"
										...
										<div class="thumbnail">
											...
											<div class="caption">
												<a href="/user/mypage?id=${itemvo.id}">
													<h3 id="itemid">${itemvo.id}</h3>
												</a> <a href="/item/readposting?clothcode=${itemvo.clothcode}">
													<p style="color: #999999;">${itemvo.name}</p>
												</a>
												<p style="color: #d9534f;">${itemvo.price}원</p>
												<div class="caption1">
													<p>
