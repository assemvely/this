			...
			<div>
				<div>
					<div class="col-md-12">
								...
								<div class="row">
									...
									<c:forEach items="${SELECTCATEGORY}" var="accvo">
										<div class="col-lg-3 text-center">
											...
											<div class="thumbnail">
												<a href="/item/readposting?clothcode=${accvo.clothcode}">
													<img src="data:image/jpeg;base64,${accvo.imgname} "													alt="No Image">
												</a>
												<div class="caption">
													<a href="/user/mypage?id=${accvo.id}">
														<h3 id="itemid">${accvo.id}</h3>
													</a> <a href="/item/readposting?clothcode=${accvo.clothcode}">
														<p style="color: #999999;">${accvo.name}</p>
													</a>
													<p style="color: #d9534f;">${accvo.price}원</p>
													<div class="caption1">
														<p>
						...
						<!-- <hr style="border-top:1px solid #d953"src/main/webapp/WEB-INF/views/css.jinc"4f;">					 -->
