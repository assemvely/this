...
var imginfolist = new Array();
	
<c:forEach items="${codiinfolist}" var="info">

var onecloth = new Object();

onecloth.clothcode = "${info.clothcode}";
onecloth.itemcoordinate_x = "${info.coordinate_x}";
onecloth.itemcoordinate_y = "${info.coordinate_y}";
onecloth.itemwidth = "${info.width}";
onecloth.itemheight = "${info.height}";
onecloth.itemimagename = "${info.imgname}";
onecloth.ratiomagnify = "${info.ratiomagnify}";
onecloth.src = "/resources/itemimg/${info.imgname}"

imginfolist.push(onecloth);	
</c:forEach>
	...
	for(var i=0; i<imginfolist.length; i++)
		{
			...
			console.log(imginfolist);
				...
				x:imginfolist[i].itemcoordinate_x,
				y:imginfolist[i].itemcoordinate_y,
				clothcode:imginfolist[i].clothcode,
				width:imginfolist[i].itemwidth,
				height:imginfolist[i].itemheight,
				order:i,
				isDragging: false,
				ratioMagnify:imginfolist[i].ratiomagnify,
				isManifying: false
