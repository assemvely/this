    ...
    border-radius:6px;
							...
							<table class="tg" width="800px" height="100px"
								...
								<tr>
									...
									<th class="tg-031e">탈퇴</th>
									<th class="tg-031e">승인</th>
								</tr>

								<c:forEach items="${templist}" var="userVO">
									<tr>
										<td class="tg-yw4l"><a style="color: black;"
											href="/user/toreadtempuserinfo?id=${userVO.id}">${userVO.id}</a></td>
										<td class="tg-yw4l"><button
												onclick="location.href='/user/deletetempuser?id=${userVO.id}'">삭제</button></td>
										<td class="tg-yw4l"><button
												onclick="location.href='/user/approve?id=${userVO.id}'">승인</button></td>
									</tr>
								</c:forEach>
							</table>
							<br /> <br /> <br /> <br />
